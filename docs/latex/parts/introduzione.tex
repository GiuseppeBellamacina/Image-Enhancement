...
\begin{itemize}
    ...
    \item A fair comparison of seven architectures under controlled conditions, with extensive ablation studies;
...
\begin{itemize}
    ...
    \item \textbf{Mattia Campanella} --- Denoising Autoencoder;
    \item \textbf{Daniele Barbagallo} --- Pix2Pix, GAN, NAFNet, and Swin2SR.
\end{itemize}
