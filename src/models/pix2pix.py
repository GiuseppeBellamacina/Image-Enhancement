...
class Pix2PixGenerator(nn.Module):
    ...
    def __init__(
        ...
        self.enc1 = self._conv_block(
            in_channels, features, normalize=False
        ...
        self.dec2 = self._upconv_block(
            features * 16, features * 8, dropout=True
        )  # *16 due to concatenation
...
class PatchGANDiscriminator(nn.Module):
    ...
    def __init__(self, in_channels: int = 6, features: int = 64):
        ...
        self.model = nn.Sequential(
            ...
            self._conv_block(
                features * 4, features * 8, stride=1
            ),  # (B, 512, H/8, W/8)
